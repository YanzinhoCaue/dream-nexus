...
const DreamApp = () => {
  ...
  return (
    <div className="w-screen h-screen text-white overflow-hidden font-inter animate-in fade-in duration-500 relative">
      ...
      <div className="absolute top-4 left-4 right-4 z-50 md:hidden">
        <div className="flex items-start gap-3">
          ...
          <div className="min-w-0 flex-1">
            <h1 className="text-base sm:text-lg font-oxanium font-bold text-white drop-shadow-[0_0_10px_#00E5FF] truncate">{currentProject?.title || 'DREAM NEXUS'}</h1>
            ...
            <div className="mt-2 flex items-center gap-2 flex-wrap">
              ...
              <div className="flex items-center gap-2 font-oxanium text-[10px] tracking-widest uppercase bg-black/50 px-2.5 py-1 rounded border border-white/5">
      ...
      <div className="hidden md:flex absolute top-6 left-8 z-10 items-center gap-6">
